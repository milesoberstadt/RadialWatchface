...
public class CircleView extends View {
    ...
    public void init(AttributeSet attrs)
    {
        ...
        TypedArray attrsArray = getContext().obtainStyledAttributes(attrs, R.styleable.simpleCircle);
        circleRadius = attrsArray.getInteger(R.styleable.simpleCircle_radius, 0);
        circleFillColor = attrsArray.getColor(R.styleable.simpleCircle_fillColor, 16777215);
        circleStrokeColor = attrsArray.getColor(R.styleable.simpleCircle_strokeColor, -1);
        circleStartAngle = 0;
        circleEndAngle = 360;
